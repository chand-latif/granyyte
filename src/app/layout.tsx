...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "mobile app development agency Pakistan",
    ...
    "website developer in Sialkot",
    "software developer in Sialkot",
    "custom software development in Sialkot",
    "inventory management system Sialkot",
    "school management software Sialkot",
    "attendance management system Sialkot",
    "import export website development Sialkot",
  ],
  openGraph: {
    type: "website",
    siteName: site.name,
...
const organizationJsonLd = {
  ...
  areaServed: ["Sialkot", "Pakistan", "Worldwide"],
