...
export const posts: Post[] = [
  {
    ...
    description:
      "Native means two separate codebases, more time, and more budget. With Flutter and FlutterFlow you ship the same product in roughly three times less time and money. Here's the honest breakdown from a certified FlutterFlow expert.",
    date: "2026-07-02",
  ...
  },
  {
    ...
    description:
      "Real mobile app development costs in 2026, where apps start from around $500 and scale with requirements. What drives the price, where you save, and why one Flutter codebase makes it affordable.",
    date: "2026-07-02",
    readingTime: "7 min read",
