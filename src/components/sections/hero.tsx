...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={reduce ? undefined : { y, opacity }}
        className="relative mx-auto w-full max-w-4xl px-5 pb-24 pt-32 text-center md:px-8 md:pt-40"
      >
        {/* Copy */}
        <div>
          <Reveal>
          ...
          <Reveal delay={0.6}>
            <p className="mx-auto mt-10 max-w-md text-base leading-relaxed text-muted md:text-lg">
              idea.compile().ship() — iOS, Android, web.
            </p>
          </Reveal>
          <Reveal delay={0.7}>
        ...
        {/* Founder portrait section hidden */}
      </motion.div>
